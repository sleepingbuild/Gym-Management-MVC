...
namespace GYM_MANAGEMENT_SYSTEM.Controllers
{
    ...
    public class PaymentController : Controller
    {
        ...
        // GET: /Payment/History
        // NOTE: đây trước đây có 2 action cùng tên "History" (1 bản không tham số,
        // 1 bản nhận PaymentHistoryFilterViewModel) gây lỗi AmbiguousMatchException.
        // Đã xóa bản không tham số vì bản này (có filter + thống kê) bao gồm đầy đủ
        // chức năng của bản kia — khi gọi /Payment/History không kèm query string,
        // toàn bộ điều kiện if bên dưới đều false nên sẽ tự rơi vào nhánh
        // GetPaymentHistoryAsync(userId), hành vi giống hệt bản cũ.
