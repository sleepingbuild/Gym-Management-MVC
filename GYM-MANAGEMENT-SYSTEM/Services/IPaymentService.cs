...
namespace GYM_MANAGEMENT_SYSTEM.Services
{
    public interface IPaymentService
    {
        ...
        Task<Payment> ConfirmLocalPaymentAsync(PaymentCreateViewModel model);

        Task<Membership?> GetCurrentMembershipAsync(string userId);
        ...
        Task<IEnumerable<Payment>> GetAllPaymentsAsync(DateTime? fromDate = null, DateTime? toDate = null);
        Task<IEnumerable<Payment>> GetAllPaymentsByStatusAsync(string status);
        Task<IEnumerable<Payment>> SearchAllPaymentsAsync(string? searchTerm = null, DateTime? fromDate = null, DateTime? toDate = null);
        Task<PaymentStatisticsViewModel> GetOverallPaymentStatisticsAsync();
